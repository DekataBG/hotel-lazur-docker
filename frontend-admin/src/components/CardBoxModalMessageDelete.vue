...
async function deleteMessage(){
  ...
  await axios.delete(`http://127.0.0.1:8000/messages/${props.modelValue.id}`)
...
<template>
  <OverlayLayer v-show="value" @overlay-click="cancel">
    ...
    >
      ...
      <div class="space-y-3">
        Are you sure you want to delete the email from {{ email }}?
      </div>

      <template #footer>
        <BaseButtons>
          <BaseButton :label="buttonLabel" :color="button" @click="deleteMessage()" />
